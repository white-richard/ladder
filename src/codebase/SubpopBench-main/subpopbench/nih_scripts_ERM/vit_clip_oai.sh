#!/bin/sh
#SBATCH --output=src/psc_logs/subpopbench/nih-ERM/nih-vit_clip_oai-%j.out
...
slurm_output_train1=src/psc_logs/subpopbench/nih-ERM/nih-vit_clip_oai-$CURRENT.out
