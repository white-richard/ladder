#!/bin/sh
#SBATCH --output=src/psc_logs/subpopbench/celebA_vit/CORAL_%j.out
...
slurm_output_train1=src/psc_logs/subpopbench/celebA_vit/CORAL_$CURRENT.out
