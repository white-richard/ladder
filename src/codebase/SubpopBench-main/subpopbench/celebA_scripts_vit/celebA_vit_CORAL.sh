#!/bin/sh
#SBATCH --output=Ladder/src/psc_logs/subpopbench/celebA_vit/CORAL_%j.out
...
slurm_output_train1=Ladder/src/psc_logs/subpopbench/celebA_vit/CORAL_$CURRENT.out
...
python Ladder/src/codebase/SubpopBench-main/subpopbench/train.py \
       ...
       --output_dir "Ladder/out/CelebA/CORAL" \
