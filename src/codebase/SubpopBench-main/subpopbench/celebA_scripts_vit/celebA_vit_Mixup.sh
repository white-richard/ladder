#!/bin/sh
#SBATCH --output=Ladder/src/psc_logs/subpopbench/celebA_vit/Mixup-%j.out
...
slurm_output_train1=Ladder/src/psc_logs/subpopbench/celebA_vit/Mixup-$CURRENT.out
...
python Ladder/src/codebase/SubpopBench-main/subpopbench/train.py \
       ...
       --output_dir "Ladder/out/CelebA/Mixup" \
