#!/bin/sh
#SBATCH --output=src/psc_logs/subpopbench/celebA_vit/BSoftmax-%j.out
...
slurm_output_train1=src/psc_logs/subpopbench/celebA_vit/BSoftmax-$CURRENT.out
...
python src/codebase/SubpopBench-main/subpopbench/train.py \
       ...
       --train_attr yes \
       --data_dir "data" \
       --output_dir "out/CelebA/BSoftmax" \
