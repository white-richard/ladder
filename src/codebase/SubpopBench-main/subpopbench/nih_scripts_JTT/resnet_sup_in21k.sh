#!/bin/sh
#SBATCH --output=Ladder/src/psc_logs/subpopbench/nih-JTT/nih-resnet_sup_in21k-%j.out
...
slurm_output_train1=Ladder/src/psc_logs/subpopbench/nih-JTT/nih-resnet_sup_in21k-$CURRENT.out
