#!/bin/sh
#SBATCH --output=Ladder/src/psc_logs/subpopbench/nih-JTT/nih-vit_sup_swag-%j.out
...
slurm_output_train1=Ladder/src/psc_logs/subpopbench/nih-JTT/nih-vit_sup_swag-$CURRENT.out
