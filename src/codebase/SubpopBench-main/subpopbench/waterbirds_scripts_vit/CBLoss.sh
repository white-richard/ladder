#!/bin/sh
#SBATCH --output=Ladder/src/psc_logs/subpopbench/waterbirds_vit/CBLoss-%j.out
...
slurm_output_train1=Ladder/src/psc_logs/subpopbench/waterbirds_vit/CBLoss-$CURRENT.out
