#!/bin/sh
#SBATCH --output=Ladder/src/psc_logs/subpopbench/waterbirds_vit/ReWeight-%j.out
...
slurm_output_train1=Ladder/src/psc_logs/subpopbench/waterbirds_vit/ReWeight-$CURRENT.out
