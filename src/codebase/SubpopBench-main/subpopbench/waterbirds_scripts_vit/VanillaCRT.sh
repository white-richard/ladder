#!/bin/sh
#SBATCH --output=src/psc_logs/subpopbench/waterbirds_vit/VanillaCRT-%j.out
...
slurm_output_train1=src/psc_logs/subpopbench/waterbirds_vit/VanillaCRT-$CURRENT.out
