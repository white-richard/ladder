#!/bin/sh
#SBATCH --output=Ladder/src/psc_logs/subpopbench/waterbirds_vit/JTT-%j.out
...
slurm_output_train1=Ladder/src/psc_logs/subpopbench/waterbirds_vit/JTT-$CURRENT.out
