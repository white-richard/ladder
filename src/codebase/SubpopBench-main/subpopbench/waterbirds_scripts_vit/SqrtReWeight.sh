#!/bin/sh
#SBATCH --output=Ladder/src/psc_logs/subpopbench/waterbirds_vit/SqrtReWeight-%j.out
...
slurm_output_train1=Ladder/src/psc_logs/subpopbench/waterbirds_vit/SqrtReWeight-$CURRENT.out
