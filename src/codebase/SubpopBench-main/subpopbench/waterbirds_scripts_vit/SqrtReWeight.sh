#!/bin/sh
#SBATCH --output=src/psc_logs/subpopbench/waterbirds_vit/SqrtReWeight-%j.out
...
slurm_output_train1=src/psc_logs/subpopbench/waterbirds_vit/SqrtReWeight-$CURRENT.out
