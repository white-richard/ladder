#!/bin/sh
#SBATCH --output=Ladder/src/psc_logs/subpopbench/nih-GroupDRO/nih-resnet_simclr_in1k-%j.out
...
slurm_output_train1=Ladder/src/psc_logs/subpopbench/nih-GroupDRO/nih-resnet_simclr_in1k-$CURRENT.out
...
python Ladder/src/codebase/SubpopBench-main/subpopbench/train.py \
       ...
       --output_dir "Ladder/out/NIH_Cxrclip" \
