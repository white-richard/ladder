#!/bin/sh
#SBATCH --output=src/psc_logs/subpopbench/nih-GroupDRO/nih-vit_sup_in1k-%j.out
...
slurm_output_train1=src/psc_logs/subpopbench/nih-GroupDRO/nih-vit_sup_in1k-$CURRENT.out
