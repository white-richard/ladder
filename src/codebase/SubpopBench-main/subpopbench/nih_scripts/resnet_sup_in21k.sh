#!/bin/sh
#SBATCH --output=src/psc_logs/subpopbench/nih-ERM/nih-resnet_sup_in21k-%j.out
...
slurm_output_train1=src/psc_logs/subpopbench/nih-ERM/nih-resnet_sup_in21k-$CURRENT.out
