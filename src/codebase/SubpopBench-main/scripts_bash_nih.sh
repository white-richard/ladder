...
python Subpop_data/subpopbench/train.py \
--dataset NIH_dataset \
--data_dir  /restricted/projectnb/batmanlab/chyuwang/Subpop_data/subpopbench/third_party/ \
--train_attr yes --algorithm ERM --output_dir Subpop_data/subpopbench/output/resnet_simclr_in1k/ \
...
python Ladder/src/codebase/SubpopBench-main/subpopbench/train.py \
       ...
       --dataset "NIH_dataset" \
       --train_attr yes \
       --data_dir "Ladder/src/codebase/SubpopBench-main/third_party" \
