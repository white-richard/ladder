#!/bin/sh
#SBATCH --output=Ladder/src/psc_logs/subpopbench/celebA_%j.out
...
slurm_output_train1=Ladder/src/psc_logs/subpopbench/celebA_seed0_$CURRENT.out
slurm_output_train2=Ladder/src/psc_logs/subpopbench/celebA_seed1_$CURRENT.out
slurm_output_train3=Ladder/src/psc_logs/subpopbench/celebA_seed2_$CURRENT.out
