...
IMG_DIR="processed_png_full"
CSV_PATH="${DATA_DIR}/metadata/manifest_full_mammograms.csv"
LABEL="breast_birads"
TASK_TYPE="multiclass"
# Example for BI-RADS multiclass:
# LABEL="breast_birads"
# TASK_TYPE="multiclass"
PRETRAINED_CHECKPOINT="out/RSNA/fold0/efficientnetb5_seed_10_fold0_best_aucroc_ver084.pth"
OUT_DIR="out/RSNA_CBIS/fold0_encoder_finetune"
