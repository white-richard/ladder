...
python ./src/codebase/train_classifier_Mammo.py \
  --data-dir 'shared/Data/RSNA_Breast_Imaging/Dataset/' \
...
python ./src/codebase/save_img_reps.py \
  ...
  --classifier_check_pt="/home/richw/.code/hyp-mammo/reposmodel_weights/vindr_efficientnetb5_seed_10_fold0_best_aucroc_ver084.pth" \
  --flattening-type="adaptive" \
  --clip_vision_encoder="tf_efficientnet_b5_ns-detect" \
  --clip_check_pt "/home/richw/.code/hyp-mammo/reposmodel_weights/mammoClip-b5-model-best-epoch-7.tar" \
  --data_dir="shared/Data/RSNA_Breast_Imaging/Dataset/RSNA_Cancer_Detection" \
  --save_path="out/RSNA/fold{}/aucroc0.89" \
  --tokenizers="shawn24/PhD" \
  --cache_dir="shawn24/PhD"
